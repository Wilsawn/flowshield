  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-[13px] text-white/30 mt-1">Usage-based on-chain fees + API subscription. Start free, no credit card required.</p>
      </div>
      <PricingSection />
      <p className="mt-12 pt-8 border-t border-white/[0.06] text-center text-[12px] text-white/35">
