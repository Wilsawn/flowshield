    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      {stats.map((stat, i) => (
        <button
          ...
          className="group p-5 rounded-xl border border-emerald-500/[0.08] bg-[#0a0f0c]/80 text-left hover:border-emerald-500/[0.15] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
        >
